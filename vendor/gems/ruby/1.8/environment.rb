...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/searchlogic-2.4.2/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/searchlogic-2.4.2/lib")
  ...
  @bundled_specs["searchlogic"] = eval(File.read("#{dir}/specifications/searchlogic-2.4.2.gemspec"))
  @bundled_specs["searchlogic"].loaded_from = "#{dir}/specifications/searchlogic-2.4.2.gemspec"
